...
Received message: {"type": "pon", "tiles": ["5s", "5s", "5s"], "player_index": 1}
Received message: {"type": "chi", "tiles": ["1m", "2m", "3m"], "player_index": 0,"target_player_index":}
...
在me,left,right,front里添加一个变量turn

到谁的轮次，就修改对应turn

首先是自动打牌会修改轮次(全局)

#####　draw全局能看到,就用draw来当作修改轮次的一个指标q

draw_seft

draw_other

这是谁的轮次，但是当当前轮次跳过时要把ｔｕｒｎ关闭，寻找一个指标，知道谁的轮次跳过了，有其他人摸牌，就是轮次跳过了



{"type": "join", "data": {"name": "lozijy", "user_id": "12345", "email": "2411107302@qq.com", "total_score": 100, "in_table": "0001"}
